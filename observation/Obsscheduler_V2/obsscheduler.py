...
class ObsScheduler(mainConfig):
    ...
    def set_obs_info(self, name_telescope):
        ...
        self.civil_allnight = self._get_allnight(horizon = -10)
...
if __name__ == '__main__':
    ...
    data_original = data_original[:300]
    ...
    obs = ObsScheduler(target_db = data, project = project, name_telescope = 'LSGT', entire_night = True, date = date, duplicate_when_empty= False)
