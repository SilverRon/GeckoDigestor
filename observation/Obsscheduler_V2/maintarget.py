...
if __name__ == '__main__':
    ...
    observer = mainObserver(name_telescope = 'KCT', **config)
    A = mainTarget(name_telescope = 'KCT', observer = observer, target_ra =-0.8704, target_dec = -31.2058, target_name = 'Center')
    A.staralt()
    #%%
    b= A.meridiantime()
    A.risetime()
